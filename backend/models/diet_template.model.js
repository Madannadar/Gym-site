...
const recordDietTemplate = async (templateData) => {
  const {
    created_by,
    name,
    description,
...
const fetchAllDietTemplates = async () => {
...
const fetchDietTemplateById = async (template_id) => {
  const result = await db.query(
...
const updateDietTemplateById = async (template_id, updateData) => {
...
const deleteDietTemplateById = async (template_id) => {
  const result = await db.query(
...
const fetchDietTemplatesByUserId = async (user_id) => {
  const result = await db.query(
...
const deleteAllDietTemplatesByUserId = async (user_id) => {
  const result = await db.query(
