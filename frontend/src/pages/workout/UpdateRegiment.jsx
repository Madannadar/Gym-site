...
//       try {
//         const regimentRes = await axios.get(`${API_URL}/workouts/regiments/${regimentId}`);
//         setFormData(regimentRes.data.item);
//       } catch (err) {
...
//       try {
//         const workoutsRes = await axios.get(`${API_URL}/workouts`);
//         setAvailableWorkouts(workoutsRes.data.items || []);
//       } catch (err) {
...
//     try {
//       await axios.put(`${API_URL}/workouts/regiments/${regimentId}`, {
//         name,
//         description,
...
//     } catch (err) {
//       const msg = err?.response?.data?.error?.message || "Failed to update regiment.";
//       setError(msg);
//     }
//   };
...
//       <h2 className="text-2xl font-bold mb-6 text-[#4B9CD3]">Update Workout Regiment</h2>
